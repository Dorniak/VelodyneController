...
public:
	...
	void Analisys(List<Punto3D^>^ puntosControl, List<Obstaculo^>^ ObstaculosControl, cli::array<Object^>^ ParamAnalisys, List<int>^ Conclusiones, cli::array<bool>^ Flags, cli::array<Thread^>^ Threads, String^* Informe, OpenGl^ Dibujador);
	void Analisys(List<Punto3D^>^ puntosController, List<Obstaculo^>^ ObstaculosController, cli::array<Object^>^ ParamAnalisys, List<int>^ Conclusiones, cli::array<bool>^ Flags, cli::array<Thread^>^ Threads, String^* Informe);
	//Funcion de thread
	void AnalisysThread();
